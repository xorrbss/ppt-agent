...
import PitchDeckCenteredCoverWithFooterMeta, {
  Schema as PitchDeckCenteredCoverWithFooterMetaSchema,
  slideLayoutId as PitchDeckCenteredCoverWithFooterMetaId,
  slideLayoutName as PitchDeckCenteredCoverWithFooterMetaName,
  slideLayoutDescription as PitchDeckCenteredCoverWithFooterMetaDesc,
} from "./pitch-deck/CenteredCoverWithFooterMeta";
import PitchDeckFullWidthStatement, {
  Schema as PitchDeckFullWidthStatementSchema,
  slideLayoutId as PitchDeckFullWidthStatementId,
  slideLayoutName as PitchDeckFullWidthStatementName,
  slideLayoutDescription as PitchDeckFullWidthStatementDesc,
} from "./pitch-deck/FullWidthStatement";
import PitchDeckMediaAndTextSplit, {
  Schema as PitchDeckMediaAndTextSplitSchema,
  slideLayoutId as PitchDeckMediaAndTextSplitId,
  slideLayoutName as PitchDeckMediaAndTextSplitName,
  slideLayoutDescription as PitchDeckMediaAndTextSplitDesc,
} from "./pitch-deck/MediaAndTextSplit";
import PitchDeckTextAndChartSplit, {
  Schema as PitchDeckTextAndChartSplitSchema,
  slideLayoutId as PitchDeckTextAndChartSplitId,
  slideLayoutName as PitchDeckTextAndChartSplitName,
  slideLayoutDescription as PitchDeckTextAndChartSplitDesc,
} from "./pitch-deck/TextAndChartSplit";
import PitchDeckCardsWithChartSplit, {
  Schema as PitchDeckCardsWithChartSplitSchema,
  slideLayoutId as PitchDeckCardsWithChartSplitId,
  slideLayoutName as PitchDeckCardsWithChartSplitName,
  slideLayoutDescription as PitchDeckCardsWithChartSplitDesc,
} from "./pitch-deck/CardsWithChartSplit";
import PitchDeckAdaptiveValueCardGrid, {
  Schema as PitchDeckAdaptiveValueCardGridSchema,
  slideLayoutId as PitchDeckAdaptiveValueCardGridId,
  slideLayoutName as PitchDeckAdaptiveValueCardGridName,
  slideLayoutDescription as PitchDeckAdaptiveValueCardGridDesc,
} from "./pitch-deck/AdaptiveValueCardGrid";
import PitchDeckAdaptiveMediaCardGrid, {
  Schema as PitchDeckAdaptiveMediaCardGridSchema,
  slideLayoutId as PitchDeckAdaptiveMediaCardGridId,
  slideLayoutName as PitchDeckAdaptiveMediaCardGridName,
  slideLayoutDescription as PitchDeckAdaptiveMediaCardGridDesc,
} from "./pitch-deck/AdaptiveMediaCardGrid";
import PitchDeckHeadlineWithDetailColumns, {
  ...
  slideLayoutName as PitchDeckHeadlineWithDetailColumnsName,
  slideLayoutDescription as PitchDeckHeadlineWithDetailColumnsDesc,
} from "./pitch-deck/HeadlineWithDetailColumns";
import PitchDeckNumberedMultiColumnOverview, {
  Schema as PitchDeckNumberedMultiColumnOverviewSchema,
  slideLayoutId as PitchDeckNumberedMultiColumnOverviewId,
  slideLayoutName as PitchDeckNumberedMultiColumnOverviewName,
  slideLayoutDescription as PitchDeckNumberedMultiColumnOverviewDesc,
} from "./pitch-deck/NumberedMultiColumnOverview";
import PitchDeckPanelListWithMedia, {
  Schema as PitchDeckPanelListWithMediaSchema,
  slideLayoutId as PitchDeckPanelListWithMediaId,
  slideLayoutName as PitchDeckPanelListWithMediaName,
  slideLayoutDescription as PitchDeckPanelListWithMediaDesc,
} from "./pitch-deck/PanelListWithMedia";
import PitchDeckHorizontalTimeline, {
  Schema as PitchDeckHorizontalTimelineSchema,
  slideLayoutId as PitchDeckHorizontalTimelineId,
  slideLayoutName as PitchDeckHorizontalTimelineName,
  slideLayoutDescription as PitchDeckHorizontalTimelineDesc,
} from "./pitch-deck/HorizontalTimeline";
import PitchDeckOverlappingCircleCards, {
  Schema as PitchDeckOverlappingCircleCardsSchema,
  slideLayoutId as PitchDeckOverlappingCircleCardsId,
  slideLayoutName as PitchDeckOverlappingCircleCardsName,
  slideLayoutDescription as PitchDeckOverlappingCircleCardsDesc,
} from "./pitch-deck/OverlappingCircleCards";
// Code templates
import CodeSlide01RoadmapCover, {
  Schema as CodeRoadmapCoverSchema,
  slideLayoutId as CodeRoadmapCoverId,
  slideLayoutName as CodeRoadmapCoverName,
  slideLayoutDescription as CodeRoadmapCoverDesc,
} from "./Code/CoverSlide";
import CodeSlide02CodeExplanationSplit, {
  Schema as CodeExplanationSplitSchema,
  slideLayoutId as CodeExplanationSplitId,
  slideLayoutName as CodeExplanationSplitName,
  slideLayoutDescription as CodeExplanationSplitDesc,
} from "./Code/CodeExplanationSplitSlide";
import CodeSlide03ApiRequestResponse, {
  Schema as CodeApiRequestResponseSchema,
  slideLayoutId as CodeApiRequestResponseId,
  slideLayoutName as CodeApiRequestResponseName,
  slideLayoutDescription as CodeApiRequestResponseDesc,
} from "./Code/APIRequestResponseSlide";
import CodeSlide04FeatureGrid, {
  Schema as CodeFeatureGridSchema,
  slideLayoutId as CodeFeatureGridId,
  slideLayoutName as CodeFeatureGridName,
  slideLayoutDescription as CodeFeatureGridDesc,
} from "./Code/CardsGridSlide";
import CodeSlide05ComparisonTable, {
  Schema as CodeComparisonTableSchema,
  slideLayoutId as CodeComparisonTableId,
  slideLayoutName as CodeComparisonTableName,
  slideLayoutDescription as CodeComparisonTableDesc,
} from "./Code/TableSlide";
import CodeSlide06Workflow, {
  Schema as CodeWorkflowSchema,
  slideLayoutId as CodeWorkflowId,
  slideLayoutName as CodeWorkflowName,
  slideLayoutDescription as CodeWorkflowDesc,
} from "./Code/WorkflowSlide";
import CodeSlide07UseCaseList, {
  Schema as CodeUseCaseListSchema,
  slideLayoutId as CodeUseCaseListId,
  slideLayoutName as CodeUseCaseListName,
  slideLayoutDescription as CodeUseCaseListDesc,
} from "./Code/TwoColumnBulletListSlide";
import CodeSlide08CodeExplanationText, {
  Schema as CodeExplanationTextSchema,
  slideLayoutId as CodeExplanationTextId,
  slideLayoutName as CodeExplanationTextName,
  slideLayoutDescription as CodeExplanationTextDesc,
} from "./Code/DescriptionTextSlide";
import CodeSlide09TableOfContent, {
  Schema as CodeTableOfContentSchema,
  slideLayoutId as CodeTableOfContentId,
  slideLayoutName as CodeTableOfContentName,
  slideLayoutDescription as CodeTableOfContentDesc,
} from "./Code/TableOfContentSlide";
import CodeSlide10MetricsSplit, {
  Schema as CodeMetricsSplitSchema,
  slideLayoutId as CodeMetricsSplitId,
  slideLayoutName as CodeMetricsSplitName,
  slideLayoutDescription as CodeMetricsSplitDesc,
} from "./Code/DescriptionAndMetricsSlide";
import CodeSlide11MetricsGrid, {
  Schema as CodeMetricsGridSchema,
  slideLayoutId as CodeMetricsGridId,
  slideLayoutName as CodeMetricsGridName,
  slideLayoutDescription as CodeMetricsGridDesc,
} from "./Code/MetricsGridSlide";

// Education templates
import EducationCoverSlide, {
  Schema as EduCoverSchema,
  slideLayoutId as EduCoverId,
  slideLayoutName as EduCoverName,
  slideLayoutDescription as EduCoverDesc,
} from "./Education/EducationCoverSlide";
import EducationTableOfContentsSlide, {
  Schema as EduTocSchema,
  slideLayoutId as EduTocId,
  slideLayoutName as EduTocName,
  slideLayoutDescription as EduTocDesc,
} from "./Education/EducationTableOfContentsSlide";
import EducationAboutSlide, {
  Schema as EduAboutSchema,
  slideLayoutId as EduAboutId,
  slideLayoutName as EduAboutName,
  slideLayoutDescription as EduAboutDesc,
} from "./Education/EducationAboutSlide";
import EducationContentSplitSlide, {
  Schema as EduContentSplitSchema,
  slideLayoutId as EduContentSplitId,
  slideLayoutName as EduContentSplitName,
  slideLayoutDescription as EduContentSplitDesc,
} from "./Education/EducationContentSplitSlide";
import EducationImageGallerySlide, {
  Schema as EduImageGallerySchema,
  slideLayoutId as EduImageGalleryId,
  slideLayoutName as EduImageGalleryName,
  slideLayoutDescription as EduImageGalleryDesc,
} from "./Education/EducationImageGallerySlide";
import EducationReportDonutSlide, {
  Schema as EduReportDonutSchema,
  slideLayoutId as EduReportDonutId,
  slideLayoutName as EduReportDonutName,
  slideLayoutDescription as EduReportDonutDesc,
} from "./Education/EducationReportChartSlide";
import EducationServicesSplitSlide, {
  Schema as EduServicesSplitSchema,
  slideLayoutId as EduServicesSplitId,
  slideLayoutName as EduServicesSplitName,
  slideLayoutDescription as EduServicesSplitDesc,
} from "./Education/EducationServicesSplitSlide";
import EducationStatisticsGridSlide, {
  Schema as EduStatisticsGridSchema,
  slideLayoutId as EduStatisticsGridId,
  slideLayoutName as EduStatisticsGridName,
  slideLayoutDescription as EduStatisticsGridDesc,
} from "./Education/EducationStatisticsGridSlide";
import EducationTimelineSlide, {
  Schema as EduTimelineSchema,
  slideLayoutId as EduTimelineId,
  slideLayoutName as EduTimelineName,
  slideLayoutDescription as EduTimelineDesc,
} from "./Education/EducationTimelineSlide";

// Product Overview templates
import BusinessChallengesCardsSlide, {
  Schema as PoBizChallengesCardsSchema,
  slideLayoutId as PoBizChallengesCardsId,
  slideLayoutName as PoBizChallengesCardsName,
  slideLayoutDescription as PoBizChallengesCardsDesc,
} from "./ProductOverview/BusinessChallengesCardsSlide";
import BusinessChallengesGridSlide, {
  Schema as PoBizChallengesGridSchema,
  slideLayoutId as PoBizChallengesGridId,
  slideLayoutName as PoBizChallengesGridName,
  slideLayoutDescription as PoBizChallengesGridDesc,
} from "./ProductOverview/BusinessChallengesGridSlide";
import ComparisonChartSlide, {
  Schema as PoComparisonChartSchema,
  slideLayoutId as PoComparisonChartId,
  slideLayoutName as PoComparisonChartName,
  slideLayoutDescription as PoComparisonChartDesc,
} from "./ProductOverview/ComparisonChartSlide";
import ComparisonTableWithTextSlide, {
  Schema as PoComparisonTableSchema,
  slideLayoutId as PoComparisonTableId,
  slideLayoutName as PoComparisonTableName,
  slideLayoutDescription as PoComparisonTableDesc,
} from "./ProductOverview/ComparisonTableWithTextSlide";
import CoverSlide, {
  Schema as PoCoverSchema,
  slideLayoutId as PoCoverId,
  slideLayoutName as PoCoverName,
  slideLayoutDescription as PoCoverDesc,
} from "./ProductOverview/CoverSlide";
import ImageGallerySlide, {
  Schema as PoImageGallerySchema,
  slideLayoutId as PoImageGalleryId,
  slideLayoutName as PoImageGalleryName,
  slideLayoutDescription as PoImageGalleryDesc,
} from "./ProductOverview/ImageGallerySlide";
import IntroductionSlide, {
  Schema as PoIntroductionSchema,
  slideLayoutId as PoIntroductionId,
  slideLayoutName as PoIntroductionName,
  slideLayoutDescription as PoIntroductionDesc,
} from "./ProductOverview/IntroductionSlide";
import KpiCardsSlide, {
  Schema as PoKpiCardsSchema,
  slideLayoutId as PoKpiCardsId,
  slideLayoutName as PoKpiCardsName,
  slideLayoutDescription as PoKpiCardsDesc,
} from "./ProductOverview/KpiCardsSlide";
...
import MeetTeamSlide, {
  Schema as PoMeetTeamSchema,
  slideLayoutId as PoMeetTeamId,
  slideLayoutName as PoMeetTeamName,
  slideLayoutDescription as PoMeetTeamDesc,
} from "./ProductOverview/MeetTeamSlide";
import MissionVisionSlide, {
  Schema as PoMissionVisionSchema,
  slideLayoutId as PoMissionVisionId,
  slideLayoutName as PoMissionVisionName,
  slideLayoutDescription as PoMissionVisionDesc,
} from "./ProductOverview/MissionVisionSlide";
import OurServicesSlide, {
  Schema as PoOurServicesSchema,
  slideLayoutId as PoOurServicesId,
  slideLayoutName as PoOurServicesName,
  slideLayoutDescription as PoOurServicesDesc,
} from "./ProductOverview/OurServicesSlide";
import PricingPlanSlide, {
  Schema as PoPricingPlanSchema,
  slideLayoutId as PoPricingPlanId,
  slideLayoutName as PoPricingPlanName,
  slideLayoutDescription as PoPricingPlanDesc,
} from "./ProductOverview/PricingPlanSlide";
import ProcessSlide, {
  Schema as PoProcessSchema,
  slideLayoutId as PoProcessId,
  slideLayoutName as PoProcessName,
  slideLayoutDescription as PoProcessDesc,
} from "./ProductOverview/ProcessSlide";
import ReportSnapshotSlide, {
  Schema as PoReportSnapshotSchema,
  slideLayoutId as PoReportSnapshotId,
  slideLayoutName as PoReportSnapshotName,
  slideLayoutDescription as PoReportSnapshotDesc,
} from "./ProductOverview/ReportSnapshotSlide";
import TableOfContentSlide, {
  Schema as PoTableOfContentSchema,
  slideLayoutId as PoTableOfContentId,
  slideLayoutName as PoTableOfContentName,
  slideLayoutDescription as PoTableOfContentDesc,
} from "./ProductOverview/TableOfContentSlide";

// Report templates
import ReportIntroSlide, {
  Schema as RepIntroSchema,
  slideLayoutId as RepIntroId,
  slideLayoutName as RepIntroName,
  slideLayoutDescription as RepIntroDesc,
} from "./Report/IntroCoverSlide";
import TitleDescriptionImageSlide, {
  Schema as RepIntroductionImageSchema,
  slideLayoutId as RepIntroductionImageId,
  slideLayoutName as RepIntroductionImageName,
  slideLayoutDescription as RepIntroductionImageDesc,
} from "./Report/TitleDescriptionImageSlide";
import IntroductionStatsSlide, {
  Schema as RepIntroductionStatsSchema,
  slideLayoutId as RepIntroductionStatsId,
  slideLayoutName as RepIntroductionStatsName,
  slideLayoutDescription as RepIntroductionStatsDesc,
} from "./Report/MetricsSlide";
import SolutionSlide, {
  Schema as RepSolutionSchema,
  slideLayoutId as RepSolutionId,
  slideLayoutName as RepSolutionName,
  slideLayoutDescription as RepSolutionDesc,
} from "./Report/TitleImageBulletCardsSlide";
import MilestoneSlide, {
  Schema as RepMilestoneSchema,
  slideLayoutId as RepMilestoneId,
  slideLayoutName as RepMilestoneName,
  slideLayoutDescription as RepMilestoneDesc,
} from "./Report/MilestoneSlide";
import DataAnalysisListSlide, {
  Schema as RepDataAnalysisListSchema,
  slideLayoutId as RepDataAnalysisListId,
  slideLayoutName as RepDataAnalysisListName,
  slideLayoutDescription as RepDataAnalysisListDesc,
} from "./Report/BulletListWithIconTitleDescriptionSlide";
import DataAnalysisBarSlide, {
  Schema as RepDataAnalysisBarSchema,
  slideLayoutId as RepDataAnalysisBarId,
  slideLayoutName as RepDataAnalysisBarName,
  slideLayoutDescription as RepDataAnalysisBarDesc,
} from "./Report/BarChartWithBulletListWithTitleDescriptionIconSlide";
import DataAnalysisInsightBarSlide, {
  Schema as RepDataAnalysisInsightBarSchema,
  slideLayoutId as RepDataAnalysisInsightBarId,
  slideLayoutName as RepDataAnalysisInsightBarName,
  slideLayoutDescription as RepDataAnalysisInsightBarDesc,
} from "./Report/TitleDescriptionChartSlide";
import DataAnalysisLineStatsSlide, {
  Schema as RepDataAnalysisLineStatsSchema,
  slideLayoutId as RepDataAnalysisLineStatsId,
  slideLayoutName as RepDataAnalysisLineStatsName,
  slideLayoutDescription as RepDataAnalysisLineStatsDesc,
} from "./Report/TitleChartWithMetricsCardsSlide";
import DataAnalysisDashboardSlide, {
  Schema as RepDataAnalysisDashboardSchema,
  slideLayoutId as RepDataAnalysisDashboardId,
  slideLayoutName as RepDataAnalysisDashboardName,
  slideLayoutDescription as RepDataAnalysisDashboardDesc,
} from "./Report/DataAnalysisDashboardSlide";
import PerformanceSnapshotSlide, {
  Schema as RepPerformanceSnapshotSchema,
  slideLayoutId as RepPerformanceSnapshotId,
  slideLayoutName as RepPerformanceSnapshotName,
  slideLayoutDescription as RepPerformanceSnapshotDesc,
} from "./Report/TitleMetricsSlide";
import ReportServicesSlide, {
  Schema as RepServicesSchema,
  slideLayoutId as RepServicesId,
  slideLayoutName as RepServicesName,
  slideLayoutDescription as RepServicesDesc,
} from "./Report/TitleWorkflowWithTitleDescriptionSlide";
import ReportTeamSlide, {
  Schema as RepTeamSchema,
  slideLayoutId as RepTeamId,
  slideLayoutName as RepTeamName,
  slideLayoutDescription as RepTeamDesc,
} from "./Report/HorizontalHeightSpanningImagesWithTitleSlide";
...
export const codeTemplates: TemplateWithData[] = [
  createTemplateEntry(
    CodeSlide01RoadmapCover,
    CodeRoadmapCoverSchema,
    CodeRoadmapCoverId,
    CodeRoadmapCoverName,
    CodeRoadmapCoverDesc,
    "code",
    "CoverSlide"
  ),
  createTemplateEntry(
    CodeSlide02CodeExplanationSplit,
    CodeExplanationSplitSchema,
    CodeExplanationSplitId,
    CodeExplanationSplitName,
    CodeExplanationSplitDesc,
    "code",
    "CodeExplanationSplitSlide"
  ),
  createTemplateEntry(
    CodeSlide03ApiRequestResponse,
    CodeApiRequestResponseSchema,
    CodeApiRequestResponseId,
    CodeApiRequestResponseName,
    CodeApiRequestResponseDesc,
    "code",
    "APIRequestResponseSlide"
  ),
  createTemplateEntry(
    CodeSlide04FeatureGrid,
    CodeFeatureGridSchema,
    CodeFeatureGridId,
    CodeFeatureGridName,
    CodeFeatureGridDesc,
    "code",
  ...
  createTemplateEntry(
    CodeSlide05ComparisonTable,
    CodeComparisonTableSchema,
    CodeComparisonTableId,
    CodeComparisonTableName,
    CodeComparisonTableDesc,
    "code",
    "TableSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    CodeSlide07UseCaseList,
    CodeUseCaseListSchema,
    CodeUseCaseListId,
    CodeUseCaseListName,
    CodeUseCaseListDesc,
    "code",
    "TwoColumnBulletListSlide"
  ),
  createTemplateEntry(
    CodeSlide08CodeExplanationText,
    CodeExplanationTextSchema,
    CodeExplanationTextId,
    CodeExplanationTextName,
    CodeExplanationTextDesc,
    "code",
    "DescriptionTextSlide"
  ),
  createTemplateEntry(
    CodeSlide09TableOfContent,
    CodeTableOfContentSchema,
    CodeTableOfContentId,
    CodeTableOfContentName,
    CodeTableOfContentDesc,
    "code",
    "TableOfContentSlide"
  ),
  createTemplateEntry(
    CodeSlide10MetricsSplit,
    CodeMetricsSplitSchema,
    CodeMetricsSplitId,
    CodeMetricsSplitName,
    CodeMetricsSplitDesc,
    "code",
    "DescriptionAndMetricsSlide"
  ),
  createTemplateEntry(
    CodeSlide11MetricsGrid,
    CodeMetricsGridSchema,
    CodeMetricsGridId,
    CodeMetricsGridName,
    CodeMetricsGridDesc,
    "code",
...
export const educationTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    EducationImageGallerySlide,
    EduImageGallerySchema,
    EduImageGalleryId,
    EduImageGalleryName,
    EduImageGalleryDesc,
    "education",
  ...
  createTemplateEntry(
    EducationReportDonutSlide,
    EduReportDonutSchema,
    EduReportDonutId,
    EduReportDonutName,
    EduReportDonutDesc,
    "education",
  ...
  createTemplateEntry(
    EducationServicesSplitSlide,
    EduServicesSplitSchema,
    EduServicesSplitId,
    EduServicesSplitName,
    EduServicesSplitDesc,
    "education",
    "EducationServicesSplitSlide"
  ),
  createTemplateEntry(
    EducationStatisticsGridSlide,
    EduStatisticsGridSchema,
    EduStatisticsGridId,
    EduStatisticsGridName,
    EduStatisticsGridDesc,
    "education",
    "EducationStatisticsGridSlide"
  ),
  createTemplateEntry(
    EducationTimelineSlide,
    EduTimelineSchema,
    EduTimelineId,
    EduTimelineName,
    EduTimelineDesc,
...
export const productOverviewTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    TableOfContentSlide,
    PoTableOfContentSchema,
    PoTableOfContentId,
    PoTableOfContentName,
    PoTableOfContentDesc,
    "product-overview",
    "TableOfContentSlide"
  ),
  createTemplateEntry(
    IntroductionSlide,
    PoIntroductionSchema,
    PoIntroductionId,
    PoIntroductionName,
    PoIntroductionDesc,
    "product-overview",
  ...
  createTemplateEntry(
    BusinessChallengesGridSlide,
    PoBizChallengesGridSchema,
    PoBizChallengesGridId,
    PoBizChallengesGridName,
    PoBizChallengesGridDesc,
    "product-overview",
    "BusinessChallengesGridSlide"
  ),
  createTemplateEntry(
    BusinessChallengesCardsSlide,
    PoBizChallengesCardsSchema,
    PoBizChallengesCardsId,
    PoBizChallengesCardsName,
    PoBizChallengesCardsDesc,
    "product-overview",
    "BusinessChallengesCardsSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    ...
    PoComparisonChartSchema,
    PoComparisonChartId,
    PoComparisonChartName,
    PoComparisonChartDesc,
    "product-overview",
    "ComparisonChartSlide"
  ),
  createTemplateEntry(
    ComparisonTableWithTextSlide,
    PoComparisonTableSchema,
    PoComparisonTableId,
    PoComparisonTableName,
    PoComparisonTableDesc,
    "product-overview",
    "ComparisonTableWithTextSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    ReportSnapshotSlide,
    PoReportSnapshotSchema,
    PoReportSnapshotId,
    PoReportSnapshotName,
    PoReportSnapshotDesc,
    "product-overview",
    "ReportSnapshotSlide"
  ),
  createTemplateEntry(
...
export const reportTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    TitleDescriptionImageSlide,
    RepIntroductionImageSchema,
    RepIntroductionImageId,
    RepIntroductionImageName,
    RepIntroductionImageDesc,
    "report",
    "TitleDescriptionImageSlide"
  ),
  createTemplateEntry(
    IntroductionStatsSlide,
    RepIntroductionStatsSchema,
    RepIntroductionStatsId,
    RepIntroductionStatsName,
    RepIntroductionStatsDesc,
    "report",
    "MetricsSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    DataAnalysisListSlide,
    RepDataAnalysisListSchema,
    RepDataAnalysisListId,
    RepDataAnalysisListName,
    RepDataAnalysisListDesc,
    "report",
    "BulletListWithIconTitleDescriptionSlide"
  ),
  createTemplateEntry(
    DataAnalysisBarSlide,
    RepDataAnalysisBarSchema,
    RepDataAnalysisBarId,
    RepDataAnalysisBarName,
    RepDataAnalysisBarDesc,
    "report",
    "BarChartWithBulletListWithTitleDescriptionIconSlide"
  ),
  createTemplateEntry(
    DataAnalysisInsightBarSlide,
    RepDataAnalysisInsightBarSchema,
    RepDataAnalysisInsightBarId,
    RepDataAnalysisInsightBarName,
    RepDataAnalysisInsightBarDesc,
    "report",
    "TitleDescriptionChartSlide"
  ),
  createTemplateEntry(
    DataAnalysisLineStatsSlide,
    RepDataAnalysisLineStatsSchema,
    RepDataAnalysisLineStatsId,
    RepDataAnalysisLineStatsName,
    RepDataAnalysisLineStatsDesc,
    "report",
    "TitleChartWithMetricsCardsSlide"
  ),
  createTemplateEntry(
    DataAnalysisDashboardSlide,
    RepDataAnalysisDashboardSchema,
    RepDataAnalysisDashboardId,
    RepDataAnalysisDashboardName,
    RepDataAnalysisDashboardDesc,
    "report",
    "DataAnalysisDashboardSlide"
  ),
  createTemplateEntry(
    PerformanceSnapshotSlide,
    RepPerformanceSnapshotSchema,
    RepPerformanceSnapshotId,
    RepPerformanceSnapshotName,
    RepPerformanceSnapshotDesc,
    "report",
    "TitleMetricsSlide"
  ),
  createTemplateEntry(
    ...
    RepServicesDesc,
    "report",
    "TitleWorkflowWithTitleDescriptionSlide"
  ),
  createTemplateEntry(
    ReportTeamSlide,
    RepTeamSchema,
    ...
    RepTeamDesc,
    "report",
    "HorizontalHeightSpanningImagesWithTitleSlide"
  ),
];

export const pitchDeckTemplates: TemplateWithData[] = [
  createTemplateEntry(
    PitchDeckCenteredCoverWithFooterMeta,
    PitchDeckCenteredCoverWithFooterMetaSchema,
    PitchDeckCenteredCoverWithFooterMetaId,
    PitchDeckCenteredCoverWithFooterMetaName,
    PitchDeckCenteredCoverWithFooterMetaDesc,
    "pitch-deck",
    "CenteredCoverWithFooterMeta"
  ),
  createTemplateEntry(
    PitchDeckFullWidthStatement,
    PitchDeckFullWidthStatementSchema,
    PitchDeckFullWidthStatementId,
    PitchDeckFullWidthStatementName,
    PitchDeckFullWidthStatementDesc,
    "pitch-deck",
    "FullWidthStatement"
  ),
  createTemplateEntry(
    PitchDeckMediaAndTextSplit,
    PitchDeckMediaAndTextSplitSchema,
    PitchDeckMediaAndTextSplitId,
    PitchDeckMediaAndTextSplitName,
    PitchDeckMediaAndTextSplitDesc,
    "pitch-deck",
    "MediaAndTextSplit"
  ),
  createTemplateEntry(
    PitchDeckTextAndChartSplit,
    PitchDeckTextAndChartSplitSchema,
    PitchDeckTextAndChartSplitId,
    PitchDeckTextAndChartSplitName,
    PitchDeckTextAndChartSplitDesc,
    "pitch-deck",
    "TextAndChartSplit"
  ),
  createTemplateEntry(
    PitchDeckCardsWithChartSplit,
    PitchDeckCardsWithChartSplitSchema,
    PitchDeckCardsWithChartSplitId,
    PitchDeckCardsWithChartSplitName,
    PitchDeckCardsWithChartSplitDesc,
    "pitch-deck",
    "CardsWithChartSplit"
  ),
  createTemplateEntry(
    PitchDeckAdaptiveValueCardGrid,
    PitchDeckAdaptiveValueCardGridSchema,
    PitchDeckAdaptiveValueCardGridId,
    PitchDeckAdaptiveValueCardGridName,
    PitchDeckAdaptiveValueCardGridDesc,
    "pitch-deck",
    "AdaptiveValueCardGrid"
  ),
  createTemplateEntry(
    PitchDeckAdaptiveMediaCardGrid,
    PitchDeckAdaptiveMediaCardGridSchema,
    PitchDeckAdaptiveMediaCardGridId,
    PitchDeckAdaptiveMediaCardGridName,
    PitchDeckAdaptiveMediaCardGridDesc,
    "pitch-deck",
    "AdaptiveMediaCardGrid"
  ),
  createTemplateEntry(
    PitchDeckHeadlineWithDetailColumns,
    PitchDeckHeadlineWithDetailColumnsSchema,
    PitchDeckHeadlineWithDetailColumnsId,
    PitchDeckHeadlineWithDetailColumnsName,
    PitchDeckHeadlineWithDetailColumnsDesc,
    "pitch-deck",
    "HeadlineWithDetailColumns"
  ),
  createTemplateEntry(
    PitchDeckNumberedMultiColumnOverview,
    PitchDeckNumberedMultiColumnOverviewSchema,
    PitchDeckNumberedMultiColumnOverviewId,
    PitchDeckNumberedMultiColumnOverviewName,
    PitchDeckNumberedMultiColumnOverviewDesc,
    "pitch-deck",
    "NumberedMultiColumnOverview"
  ),
  createTemplateEntry(
    PitchDeckPanelListWithMedia,
    PitchDeckPanelListWithMediaSchema,
    PitchDeckPanelListWithMediaId,
    PitchDeckPanelListWithMediaName,
    PitchDeckPanelListWithMediaDesc,
    "pitch-deck",
    "PanelListWithMedia"
  ),
  createTemplateEntry(
    PitchDeckHorizontalTimeline,
    PitchDeckHorizontalTimelineSchema,
    PitchDeckHorizontalTimelineId,
    PitchDeckHorizontalTimelineName,
    PitchDeckHorizontalTimelineDesc,
    "pitch-deck",
    "HorizontalTimeline"
  ),
  createTemplateEntry(
    PitchDeckOverlappingCircleCards,
    PitchDeckOverlappingCircleCardsSchema,
    PitchDeckOverlappingCircleCardsId,
    PitchDeckOverlappingCircleCardsName,
    PitchDeckOverlappingCircleCardsDesc,
    "pitch-deck",
    "OverlappingCircleCards"
  ),
];
