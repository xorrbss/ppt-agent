...
export const layoutName = '제목 설명 멀티 차트 그리드';
export const layoutDescription = '제목, 설명과 1~6개의 자동 배치 차트를 갖춘 neo-standard 대시보드 레이아웃입니다. 막대(세로, 가로, 그룹, 누적, 클러스터, 발산), 선, 영역, 파이, 도넛, 산점도 차트를 지원합니다.';

// Theme-aware chart colors (use --graph-0, --graph-1, etc. when set by theme)
