  ...
  graphData: z
    .object({
      columns: z
        .array(z.string())
        .max(3)
        .describe("Labels for the data categories and legend items"),
      rows: z
        .array(
          z.object({
            label: z
              .string()
              .max(12)
              .describe("The name of the category shown on the X-axis"),
            value1: z
              .number()
              .describe("Value for the first series (bottom part of stack)"),
            value2: z
              .number()
              .optional()
              .describe(
...
const dynamicSlideLayout: React.FC<{
  ...
  const renderChart = () => {
    const hasValue2 =
      graphData?.rows?.some((row) => (row.value2 ?? 0) > 0) ?? false;
    ...
    const axisProps = {
      ...
      tickLine: false,
      tick: {
        fill: "var(--background-text, #333333)",
        fontSize: 16,
            ...
            >
              ...
              <Legend
                ...
                formatter={(value: any, entry: any, index: any) =>
                  graphData?.columns?.[index + 1] || value
                }
              />
              <Line
                type="monotone"
                ...
                strokeWidth={3}
                dot={{ fill: "var(--graph-0, #1F8A2E)", r: 6 }}
              />
              {hasValue2 && (
                <Line
                  type="monotone"
                  dataKey="value2"
                  stroke="var(--graph-1, #A7DBA8)"
                  strokeWidth={3}
                  dot={{ fill: "var(--graph-1, #A7DBA8)", r: 6 }}
                />
              )}
            </LineChart>
          </ResponsiveContainer>
            ...
            >
              ...
              >
                <LabelList
                  dataKey="value1"
                  position="center"
                  fill="var(--background-text, #FFFFFF)"
                  fontSize={14}
                  fontFamily="Open Sans Regular"
                />
              </Bar>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <PieChart margin={{ top: 20, right: 20, left: 20, bottom: 20 }}>
              <Pie
                ...
                labelLine={{
                  stroke: "var(--background-text, #333333)",
                  strokeWidth: 1,
                }}
              >
          ...
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart margin={{ top: 20, right: 20, left: 10, bottom: 20 }}>
              ...
              <XAxis
                type="number"
                dataKey="x"
                name={graphData?.columns?.[1]}
                {...axisProps}
              />
              <YAxis
                type="number"
                dataKey="y"
                name={graphData?.columns?.[2]}
                {...axisProps}
              />
              <Tooltip
  ...
  return (
    <>
      ...
      />
      <div
        className="relative flex flex-col w-full rounded-sm max-w-[1280px] shadow-lg h-[720px] aspect-video bg-white z-20 mx-auto overflow-hidden  p-8 box-border "
        style={{
      ...
      >
        ...
        <div className="flex justify-between items-start mb-4 relative z-10 px-8 pb-8">
          <div className="flex-1 text-center">
            <h1
              className="text-[44px] text-black  font-bold -ml-16"
        ...
        {/* Main Content Area */}
        <div
          className=" flex-grow min-h-0 overflow-hidden flex flex-col relative z-10 border-[1.3px] border-[#F0F0F2] rounded-[10px] p-6 pb-8 "
          style={{ borderColor: "var(--stroke,#F0F0F2)" }}
        >
          {/* Badge and Top Label Row */}
          <div className="flex justify-between items-end mb-4">
            <div
              className="bg-[#1F8A2E] px-8 py-3"
              style={{ backgroundColor: "var(--primary-color,#1F8A2E)" }}
            >
              <span
                className="text-[34px] text-white  font-bold leading-none"
            ...
            <div
              className="text-[22px] text-black  italic pb-1"
              style={{ color: "var(--background-text,#000000)" }}
            >
              {topDescription}
            </div>
          ...
          <div className=" absolute bottom-1 right-2 ">
            <div
              className="text-[20px] text-black  pr-4"
              style={{ color: "var(--background-text,#000000)" }}
            >
              {bottomDescription}
            </div>
