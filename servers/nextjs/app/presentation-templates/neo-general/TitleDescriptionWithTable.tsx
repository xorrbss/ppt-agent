          ...
          .array(
            z.object({
              title: z
                .string()
                .max(10)
                .describe("Title label for the bullet point"),
              description: z
                .string()
                .max(20)
      ...
      >
        ...
        <div className="flex justify-between items-start mb-[100px] w-full">
          <div className="flex flex-col basis-1/2">
            <h1
              className="text-[42.7px]  font-bold leading-[1.05] tracking-[-2.0px]"
          ...
          <div className="basis-1/2 flex justify-end">
            <p
              className="max-w-[510px] text-[16px] font-normal leading-[1.6] text-left"
        ...
        <div
          ...
          style={{ width: safeSections.length === 1 ? "60%" : "100%" }}
        >
          <div className="overflow-hidden rounded-t-[28px]">
            <table className="w-full table-fixed border-separate border-spacing-0">
                ...
                <tr>
                  {safeSections.map((section, idx) => (
                    <th
                      key={`header-${idx}`}
                      scope="col"
                      className={`py-[20px] px-[15px] text-center align-middle ${
                        idx !== safeSections.length - 1
                          ? "border-r-[1.3px] "
                          : ""
                      }`}
                    ...
                    >
                      <span
                        className="text-[21.3px] font-bold text-center"
              ...
              <tbody>
                <tr>
                  {safeSections.map((section, colIdx) => (
                    <td
                      key={`col-${colIdx}`}
                      className={`align-top pt-[20px] pb-[30px] px-[15px] ${
                        colIdx !== safeSections.length - 1
                          ? "border-r-[1.3px]"
                          : ""
                      }`}
                      style={{
                        backgroundColor: "var(--card-color,#FCFCFC)",
                    ...
                    >
                      <div className="flex flex-col gap-y-[25px]">
                        {section?.bulletPoints?.map((point, pointIdx) => (
                          <div
                            key={`point-${colIdx}-${pointIdx}`}
                            className="text-center min-h-[1.2em]"
                          >
                            <span
                              className="text-[18.7px] font-bold"
                              style={{
                            ...
                            <span
                              className="text-[18.7px] font-normal"
                              style={{
                                color: "var(--background-text,#000000)",
                              }}
                            >
        ...
        <div
          className="absolute right-[320px] bottom-[362px] w-[15.8px] h-[15.8px] rounded-full opacity-10"
