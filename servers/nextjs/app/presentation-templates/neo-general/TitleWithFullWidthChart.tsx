        ...
        return (
          ...
          >
            <span
              ...
              style={{
                backgroundColor: `var(--graph-${spreadIndex}, ${fallback})`,
              }}
            />
            {serie.name}
          </div>
...
const ChartRenderer: React.FC<{ chart: z.infer<typeof Schema>["chart"] }> = ({
  chart,
}) => {
...
const dynamicSlideLayout: React.FC<{ data: Partial<FormData> }> = ({
  data,
}) => {
    ...
    <>
      ...
      >
        ...
        <div className="mt-10 w-full min-h-0">
          <div
            className="rounded-[24px] px-6 py-6 border w-full overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="h-[400px] min-h-0 overflow-hidden">
              <ChartRenderer
                chart={
                  chartConfig ?? { categories: [], series: [], type: "bar" }
                }
              />
            </div>
          </div>
