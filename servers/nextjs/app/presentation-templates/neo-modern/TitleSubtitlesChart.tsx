  ...
  graphData: z
    .object({
      columns: z
        ...
        .max(2)
        .describe("Names of the data series"),
      rows: z
        .array(
          z.object({
            label: z
              .string()
              .max(12)
              .describe("The category label for the bar"),
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full w-full py-0">
          ...
          <div
            className="mx-[72px] relative mb-[50px] border border-[#F0F0F2] rounded-[4px] flex flex-col flex-grow bg-[#FFFFFE]"
            style={{
          ...
          >
            ...
            {/* Graph Section */}
            <div className="min-h-0 flex-1 overflow-hidden px-[65px] pb-[62px] pt-[18px]">
              {renderChart()}
            </div>
