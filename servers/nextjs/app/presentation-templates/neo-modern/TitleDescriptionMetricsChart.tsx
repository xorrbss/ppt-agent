  ...
  chartData: z
    .object({
      columns: z
        .array(z.string())
        .max(2)
        .describe("Names of the chart data series"),
      rows: z
        .array(
          z.object({
...
const dynamicSlideLayout: React.FC<{
  ...
  const renderChart = () => {
    ...
    const hasValue2 =
      chartData?.rows?.some((row) => (row.value2 ?? 0) > 0) ?? false;
              ...
              {chartData?.columns?.map((column, index) => (
                ...
                >
                  <LabelList
                    dataKey={column}
                    position="top"
                    fill="var(--background-text, #4B5563)"
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <defs>
                {chartData?.columns?.map((column, index) => (
                  <linearGradient
                    key={`metricsArea-${index}`}
                    id={`metricsArea-${index}`}
                    x1="0"
                    y1="0"
                    x2="0"
                    y2="1"
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar
                ...
                stackId="a"
                fill={graphColors(0)}
                radius={hasValue2 ? [0, 0, 0, 0] : [2, 2, 0, 0]}
                barSize={70}
                label={{
                  position: "inside",
                  fill: "var(--primary-text, #fff)",
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-white z-20 mx-auto overflow-hidden flex font-['Montserrat'] font-normal"
        style={{
      ...
      >
        <div className="flex w-full h-full p-[60px] gap-[40px]">
          ...
          <div className="flex flex-col basis-[45%] justify-center h-full">
            <h1
              className="text-[42.7px] font-bold leading-[1.1] tracking-[-1.6px] mb-[20px]"
              style={{ color: "var(--background-text,#002BB2)" }}
            >
              {title}
            </h1>
            <p
              className="text-[16px] font-normal leading-[1.6] mb-[60px]"
              style={{ color: "var(--background-text,#002BB2)" }}
            >
              {description}
            </p>
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: isEven
                        ? "var(--card-color,#6B89E6)"
                        : "var(--card-color,#F7F8FF)",
                    }}
                  >
                    <span
          ...
          <div className="flex flex-col basis-[55%] h-full justify-center">
            ...
            <div
              className="flex-grow min-h-0 overflow-hidden border rounded-[6px] p-[20px] pb-[36px] relative"
              style={{
                backgroundColor: "var(--card-color,#FFFFFF)",
