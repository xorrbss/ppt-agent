  ...
  return (
    <div className="space-y-6 ">
      ...
      <div className="mb-4 flex items-center justify-between bg-white p-10">
        <div className="">
          <h3 className="text-xl font-normal text-[#191919]">Anthropic API 키</h3>
          <p className="mt-2 text-sm max-w-[205px] text-gray-500">
            API 키는 로컬에만 저장되며 외부에 공유되지 않습니다
          </p>
        </div>
            ...
            {modelsChecked && availableModels.length === 0 && (
              <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-800">
                  사용 가능한 모델이 없습니다. API 키가 올바르며 Anthropic 모델에 접근할 수 있는지 확인해 주세요.
                </p>
              </div>
            )}
